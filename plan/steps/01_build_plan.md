...
- [ ] Phase 63 — NPC alignment observers (Spec 14 Q2 follow-up): promoted via oversight 2026-05-20 seventh-of-session. Extend `NPC` with `observesAlignment?: boolean` + per-NPC `lastSeenAlignmentCellId?` cache; reactive dialogue gate `playerAlignmentCellChangedSince?: string`; author 1 observing NPC (Old Marrow target). Independent of Phase 60 / 62 follow-ups; closes Spec 14 Q2. Score 4×5/10 = 2.0. See `plan/PHASE_CANDIDATES.md` Promoted section for full scope.
