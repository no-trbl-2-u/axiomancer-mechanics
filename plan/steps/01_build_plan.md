...
- [ ] Phase 59 — Docs gap audit + drain (re-scoped from the older Docs-sweep candidate; promoted via oversight 2026-05-20 sixth-of-day). At dispatch time the phase brief re-audits CRITIQUE pending + recent /iterate Done against the original candidate's 9 row-groups (a-i); ships whatever residual docs drift remains. If the re-audit finds zero residual, the phase ships as a single audit-summary commit and closes.
