...
- [ ] Phase 41 — Specs + Knowledge-Gaps acceptance sweep: pure docs phase. Tick every acceptance box with its commit hash across Spec 04 (skills engine — Phase 09 + Spec 04 + 04b shipped), Spec 10 (moral meter — Phase 10 shipped), Spec 23 (MapEvents — Phases 23 / 24 / 25 / 31 / 37 shipped). Update Spec 23's type sketches (`:95`, `:138`) with the Phase 37 `shop?: ShopInventory` field + add a 12th acceptance line for the shop extension. Retire `Knowledge-Gaps.md` Qs 15 / 17 / 18 / 19 / 20 with the same "resolved at <phase>" treatment Q5 / Q12 already got. Acceptance: every box in Specs 04 / 10 / 23 reads `[x]` with a commit hash; the critique-15 Spec 23 row moves to Done. Promoted via `/oversight` 2026-05-16.
