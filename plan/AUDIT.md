...
- [ ] **[E — docs drift] Phase 142 public exports absent from docs/effects.md, docs/skills.md, spec.md, and bearings.md** — `evaluateInteractions`, `checkInteractionTrigger`, `applyInteractionResult`, `EFFECT_INTERACTIONS`, `getInteractionsForEffect`, `getAllInteractionIds`, `getInteractionById`, `validateInteractions` (Effects); `STATUS_RESOLUTION_DEBUFF_THRESHOLD`, `STATUS_RESOLUTION_DOT_THRESHOLD`, `STATUS_RESOLUTION_DOT_MAX_ROUNDS`, `STATUS_ENGAGEMENT_FLOOR_PERCENT`, `INTERACTION_AMPLIFICATION`, `INTERACTION_PRIORITY` (Combat resolution constants); `evaluateExtendedSynergyPredicate`, `checkSinglePredicate`, `checkAnyCountPredicate`, `checkAllRequiredPredicate`, `checkBuffDebuffCombo`, `checkTotalIntensityPredicate`, `ExtendedSynergyPredicate` (Skills) are all on the public barrel and fixture but have no row in their respective consumer-facing docs. Score 3 × 8 / 10 = 2.4.
