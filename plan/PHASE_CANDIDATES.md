...
### Candidate: [needs-user-call] Skills always-land effects + separate damage roll (mechanic shift)
...
### Candidate: Audit — general skills audit (all 21 authored skills)
...
### Candidate: Audit — general effects audit (88 buffs + debuffs)
