...
### Candidate: Post-Phase-80 effect-application test sweep (regression coverage for the mechanic shift)
...
### Candidate: Combat-tuning audit (Knowledge-Gaps Q1 / Q2 / Q4 / Q6 / Q26 cluster)
...
### Candidate: Skill "fizzle" event + UX scrub post-Phase-80
...
### Candidate: Equipment generation audit under new effect-resolution model
...
### Candidate: Per-module quickstart pages (extend the Phase 67 pattern to module docs)
