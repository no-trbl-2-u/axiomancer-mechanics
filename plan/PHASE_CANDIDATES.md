...
- blocked-by: None on the engine side. ~~Wants user-attended oversight if the preset extension wants the full 5-synergy-known shape vs the minimum-viable 2-synergy-equipped shape.~~ **Design decision locked at oversight 2026-06-04: full coverage — extend `TIER_2_SKILLS` to all 5 Phase 66 synergy skills in `wandererPreset.knownSkills`** (not minimum-viable 2-equipped shape). Unit 1 should wire all five into the preset's known catalogue.
