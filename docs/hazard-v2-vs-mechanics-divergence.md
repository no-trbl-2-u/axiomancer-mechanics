...
Date: 2026-06-11
Status: Authoritative for current mobile `../axiomancer-mobile/state/hazard/`; refreshed after comparing latest mobile and mechanics `main`.
...
- `../axiomancer-mobile/state/hazard/types.ts`
- `../axiomancer-mobile/state/hazard/tuning.ts`
- `../axiomancer-mobile/state/hazard/engine.ts`
- `../axiomancer-mobile/state/hazard/content.ts`
- `../axiomancer-mobile/state/hazard/deck-flags.ts`
- `../axiomancer-mobile/state/hazard/store-actions.ts`
...
- `src/World/Hazard/hazard.types.ts`
- `src/World/Hazard/hazard.engine.ts`
- `src/World/Hazard/hazard.dice.ts`
- `src/World/Hazard/hazard.cards.library.ts`
- `src/World/Hazard/hazard.hazards.library.ts`
