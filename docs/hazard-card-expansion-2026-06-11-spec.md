> Ported from `axiomancer-mobile/docs/hazard-card-expansion-2026-06-11-spec.md`. Mechanics is now the Hazard rules source of truth; mobile owns UI/UX presentation.
