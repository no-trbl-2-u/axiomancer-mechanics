> Ported from `axiomancer-mobile/docs/hazard-playtest-2026-06-10-spec.md`. Mechanics is now the Hazard rules source of truth; mobile owns UI/UX presentation.
...
All balance knobs live in `src/World/Hazard/tuning.ts` (`HAZARD_TUNING`) so the
