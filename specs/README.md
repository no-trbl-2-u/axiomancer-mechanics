...
| 5 | [`05-equipment-engine.md`](./05-equipment-engine.md) | Phase 4. Depends on (1) for stat-mod aggregation. Ships types + engine only (no library content). |
| 5b | [`05b-equipment-library.md`](./05b-equipment-library.md) | Companion to (5). Ships 50 equipment pieces + 12 consumables with resource economy interactions. Depends on (5). |
